...
gwt plugin uses a jetty server running on 8080. Index page should be available with hosted mode on http://127.0.0.1:8888/index.html?gwt.codesvr=127.0.0.1:9997
